export class Parameter {
  ...
  static get routing_key() {
    return process.env.RABBITMQ_ROUTING_KEY || "routing_key";
  }
  ...
  static get exchange_name_dlq() {
    return process.env.RABBITMQ_EXCHANGE_NAME_DLQ || "dlq";
  }

  static get routing_key_dlq() {
    return process.env.RABBITMQ_ROUTING_KEY_DLQ || "routing_key_dlq";
  }
}
